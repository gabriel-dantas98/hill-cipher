...
# chave_inversa = numpy.linalg.inv(chave_origin)
#
# pprint(chave_inversa)
# pprint(inverseKey)
#
# print("Chave inversa")
...
list_normalized_b = numpy.array(list_calculated)
list_normalized_a = list_normalized_b.flatten().astype(numpy.int64)

for i in range(0, len(list_normalized_a)):
    list_normalized_a[i] = round(verify_value(list_normalized_a[i], 25))

print(list_normalized_a)
